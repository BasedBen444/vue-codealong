<template>
  ...
  blogPostContent="A muggle is a person who lacks magical ability"
  ></BlogPost>

  <BlogPost 
  id="1" 
  blog-post-title="What is a muggle?" 
  blog-post-content="A muggle is a person who lacks magical ability"
  ></BlogPost>
...
let blogPostTitle = ref(
  'HP and Cursed Child Production Suspended until April'
)

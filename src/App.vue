<template>
  ...
  <div class="card">
    ...
    <button @click="wizard2.wand.core = 'Phoenix feather'">Change wand core</button>
...
watch(() => wizard1.value.name, (newValue, oldValue) => {
  console.log('Watch property in a ref(object): wizard1 name changes', newValue, oldValue)
})

watch(() => wizard1.value.wand, (newValue, oldValue) => {
  console.log('Watch property in a ref(object): wizard1 wand changes', newValue, oldValue)
}, 
{deep: true}
)
...
watch(
  ...
  (newValue, oldValue) => {
    console.log(
      'Watch an array of ref(primitive value), a property of a ref(object) and a ref(object)', newValue, oldValue
    )
  },
  {
    deep: true

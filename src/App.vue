<template>
  ...
  <hr>
  <p>
    This is an input field where the user can only enter numbers
  </p>
  <input type="text" @keydown="handleInput($event)">

  <hr> 
  <div style="width: 100px; height: 100px; background-color: aqua;" @contextmenu.prevent="console.log('Show a custom context menu instead')"></div>

  <div id="mouseover" @mouseover="fun1($event)">
